		...
		<div className='max-w-[85%] mx-auto '>
			...
			<div className='flex flex-col md:flex-row items-center justify-between gap-4 text-secondary pb-5'>
				...
				<div className='flex gap-10'>
					<a href='https://www.facebook.com/BillWev' target='_blank' rel='noopener noreferrer'
					className='hover:text-primary'> 
						<FaFacebook size={25}/>
					</a>

					<a href='https://www.instagram.com/billwev' target='_blank' rel='noopener noreferrer'
					className='hover:text-primary'>
						<FaInstagram size={25}/>
					</a>

					<a href='https://twitter.com/BillWevApp' target='_blank' rel='noopener noreferrer'
					className='hover:text-primary'>
						<FaXTwitter size={25}/>
					</a>

					<a href='https://www.youtube.com/@BillWev' target='_blank' rel='noopener noreferrer'
					className='hover:text-primary'>
						<FaYoutube size={25}/>
					</a>
				</div>
