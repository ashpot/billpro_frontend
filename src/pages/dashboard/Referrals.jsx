...
import TopReferrers from '../../components/dashboard/shared/TopReferrers'
  ...
  return (
	<div className='bg-gray-100 flex max-h-full'>
		...
		<div className='flex-1 space-y-8 p-4 mb-5 w-[80%]'>
			<DashboardNavbar title="Referrals"/>
			<Overview title="Referral Overview" cardsData={cardsData}/>
			<div className='grid grid-cols-1 md:grid-cols-5 grid-rows-1 gap-6'>
				<div className="py-6 px-4 bg-white rounded-2xl col-span-3">
			...
			<Transactions 
				title="Users"
				columns={[
					{ header: "Referrer's Name", key: "r_name" },
					{ header: "Invitee's Name", key: "i_name" },
					{
						header: "Status",
						key: "status",
						render: (value) => (
				...
				data={[
					{ r_name: "Adetola Johnson", i_name: "Chioma Adeh", bonus: "₦12,000", biller: "MTN-NG", status: "Completed", date: "Jul 20, 2025" },
					{ r_name: "Winner Ike", i_name: "Fummi Emeh", bonus: "₦1,200", biller: "AIRTEL-NG", status: "Pending", date: "Jul 20, 2025" },
					{ r_name: "Zainab Fatima", i_name: "Chidi Okon", bonus: "₦10,000", biller: "GLO-NG", status: "Failed", date: "Jul 20, 2025" }
				]}
			/>
		</div>
