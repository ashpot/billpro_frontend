...
import { getElectricityDashboard, formatAmount, formatDate, formatToken } from "../../services/dashboardService";
    ...
    useEffect(() => {
      async function fetchDashboard() {
        try {
          ...
          const response = await getElectricityDashboard();
		...
		<div className='flex-1 space-y-8 p-4 mb-5 w-[80%]'>
          ...
          <Transactions
            ...
            columns={[
              ...
              { header: "Token", key: "token", render: (value) => formatToken(value),},
