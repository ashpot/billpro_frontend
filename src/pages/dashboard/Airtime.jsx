...
import { getAirtimeDashboard, formatAmount, formatDate } from "../../services/dashboardService";
    ...
    useEffect(() => {
      async function fetchDashboard() {
        try {
          ...
          const response = await getAirtimeDashboard();
